...
Answers are generated using an Ollama-hosted model through LangChain's \texttt{create\_stuff\_documents\_chain}, with a prompt that enforces the guard\-rails below.
...
=======
  \item Quick eval: \texttt{python -m benchmarks.model\_evaluation\_runner} \break \texttt{single ms-marco} deepseek short}
>>>>>>> 65c0981d934e760449bf221409be485512361546
