...
\flushbottom
    ...
    \input{chap3_methodology/design_and_implementations_main}
    \input{chap4_results/results_and_discussion_main}
    \input{chap5_conclusions/conclusions_main}
    \appendix
        \input{appA_setup_guide/appendix_a_main}
        \input{appC_UI_screenshots/ui_screenshots}

{\backmatter
    % Bibliography
    \if@openright\cleardoublepage\else\clearpage\fi
    \bibliographystyle{mmu-plainnat} %% MMU specific plainnat style
    {\footnotesize\bibliography{chap1_intro/introduction_biblio,chap2_lit_review/background_and_lit_overview_biblio,chap3_methodology/design_and_implementations_biblio,chap4_results/results_and_discussion_biblio}}
	\printindex
}
