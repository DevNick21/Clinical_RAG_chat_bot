# CLAUDE.md — Clinical RAG Production Refactor

## ⚠️ IMPORTANT: Context Limitation

The architecture plans in the root (plan_01 through plan_05) were produced in a claude.ai planning session that only had access to 4 source files:
...
- ⚠️ No Flask app.py exists (mentioned in CLAUDE.md, but doesn't exist) — will create properly in Phase 5
